...
class TaskRepository {
  ...
  Future<List<Task>> getTasks({int skip = 0, int limit = 10}) async {
    ...
    try {
      ...
      // Update local cache
      // Ideally we would merge lists, but for simplicity we override the cache with page 0 results
      if (skip == 0) {
  ...
  Future<Task> addTask(Task task) async {
    ...
    try {
      final response = await _dio.post(
        ...
        data: task.toJson()..remove('id'), // Ensure ID is generated by server or modify as needed
      );
